...
exports.run = async(client, message, args, ayar, emoji) => {
  let embed = new MessageEmbed().setAuthor(message.author.tag, message.author.avatarURL({dynamic: true})).setColor("2d3136").setTimestamp();
...
exports.conf = {
    aliases: ["sil", 'clear'],
    usage: "temizle 1-100",//Rowie Developer//Rowie Developer
    description: "Belirtilen mesaj sayısı kadar mesaj temizler."//Rowie Developer
}
